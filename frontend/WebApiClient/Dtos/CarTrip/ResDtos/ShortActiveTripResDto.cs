...
namespace TGBotNVK.WebApiClient.Dtos.CarTrip.ResDtos
{
    ...
    public partial record ShortActiveTripResDto
    {
        ...
        [Newtonsoft.Json.JsonProperty("freePlaces", Required = Newtonsoft.Json.Required.DisallowNull, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
